...
/**
 * Leung Cluster Algorithmn (Epidemic Label Propagation)
 */
public class LeungAlgorithm extends SolverWrapper<Node, Edge> {
	...
	public Result solve(SolverConfiguration config) {
		...
		leung.setParameters(Double.parseDouble(paramM), Double.parseDouble(paramDelta));
		leung.compute();
