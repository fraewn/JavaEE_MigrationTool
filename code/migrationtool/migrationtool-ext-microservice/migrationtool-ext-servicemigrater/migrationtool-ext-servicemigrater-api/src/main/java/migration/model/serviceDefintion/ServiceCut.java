...
public class ServiceCut {
	...
	private SortedMap<String, List<UseCase>> relatedUseCases;
	 ...
	 */
	public SortedMap<String, List<UseCase>> getRelatedUseCases() {
	 ...
	 */
	public void setRelatedUseCases(SortedMap<String, List<UseCase>> relatedUseCases) {
